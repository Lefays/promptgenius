...
export default function LandingPage() {
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: "Select from GPT-5, Claude, Gemini, Grok, and more"
    },
    {
      step: "03",
  ...
  const plans = [
    {
      name: "Free",
      price: "$0",
      description: "Everything included, forever",
      features: [
        "Unlimited prompts",
        "All AI models (GPT-5, Claude 4.6, Gemini 3.1, etc.)",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We support all major AI models including GPT-5.4, GPT-5.3, Claude Opus 4.6, Claude Sonnet 4.6, Gemini 3.1 Pro, Grok 4.1, DeepSeek v3.2, Mistral, Qwen, and many more. Our prompts are optimized for each model's specific capabilities."
    },
    {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative bg-white">
      ...
      <section ref={pricingRef} id="pricing" className="py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600">No plans, no limits, no credit card needed</p>
          </motion.div>
